...
export const initialIntendedAudiences =
  urlSearchParams.getAll("intended_audiences");
...
export const serializeStateToQueryString = ({
  ...
  filterDevelopmentStatuses.forEach((f) =>
    urlSearchParams.append("development_statuses", f)
  );
  filterIntendedAudiences.forEach((f) =>
    urlSearchParams.append("intended_audiences", f)
  );
